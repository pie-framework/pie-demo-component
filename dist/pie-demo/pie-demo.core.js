...
(function(s){s&&(resourcesUrl=s.getAttribute('data-resources-url'))})(document.querySelector("script[data-namespace='pie-demo']"));
/**
 * SSR Attribute Names
 */
...
async function update(plt, elm, perf, isInitialLoad, instance, ancestorHostElement) {
  true;
...
function defineMember(plt, property, elm, instance, memberName, hostSnapshot, perf, hostAttributes, hostAttrValue) {
  ...
  function setComponentProp(newValue, elm) {
    ...
    if (elm) if (property.state || property.mutable) setValue(plt, elm, memberName, newValue, perf); else {
      true;
...
function createPlatformMain(namespace, Context, win, doc, resourcesUrl, hydratedCssClass, components) {
...
})(window,document,{},"PieDemo","hydrated",[["pie-demo","pie-demo",1,[["collapsed",16],["configElement",16],["configModel",16],["configure",1],["configureObject",16],["currentOption",16],["editor",1,0,1,4],["elementParent1",16],["elementParent2",16],["env",16],["load",1,0,1,4],["loadPies",1],["minHeightAuthoring",16],["model",1],["mutationObserver",16],["package",16],["pie",1,0,1,2],["pieController",16],["pieElement",16],["pieElementModel",16],["pieName",16],["playerControls",1,0,"player-controls",4],["preview",1,0,1,4],["resizeObserver",16],["session",16],["state",16],["studSettVisible",16],["studentHeader",16],["studentHeaderWidth",16],["tabIndex",16]]]]);